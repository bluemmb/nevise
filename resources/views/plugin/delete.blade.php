...
@section('content')
    ...
    <div class="page-title">
        ...
        >
        <a class="not-link" href="/project/{{$project->id}}/module/{{$module->id}}/plugin/{{$plugin->title}}">
            Delete Plugin : {{$plugin->title}}
        </a>
    </div>
        ...
        <div class="box form-box" style="width:500px;">
            ...
            <div class="box-body form-box-body">
                <form class="form-horizontal" method="POST" style="margin-bottom:0px;">
                    {{ csrf_field() }}
                    <input type="hidden" name="title" value="{{ $plugin->title  }}" />

                    <div class="form-group">
                        <h4 class="col-md-12" style="line-height: 1.5em;">
                            You are about to <span style="color:#900;">DELETE</span>
                                the Plugin : <span style="color:#00a7d0;">{{ $plugin->title  }}</span><br>
                            Are you sure ?
                        </h4>
                    </div>
